...
def pipeline_C4(uniprot_merged_path, cores, goa_new, goa_old, go_owl, preferred_threshold, 
                fasta_reference, dir_tree, stop_at_filtering = False, skip_to_filtering = False, chunk_size=1000000):
    ...
    if not skip_to_filtering:
        ...
        src_collection.diamond_management_C4(dir_tree, uniprot_merged_path, cores)
        ...
        benchmark_c4_dir = benchmark_c4_dir + "/"
        fn_2_aliases = benchmark_c4_dir + "filtered_chunked_cafa4_1.tsv"
        of_2_aliases = benchmark_c4_dir + "chunked_cafa4_aliases_2.tsv"

        src_collection.find_aliases_from_filtered_diamond_2_C4(fn_2_aliases, of_2_aliases)
        ...
        of_3_retriever_2025 = benchmark_c4_dir + "chunked_go_2025_CAFA4_3.gz"
    
        src_collection.go_retriever_diamond_chunks_3_C4_fast(goa_new, fn_3_retriever, of_3_retriever_2025, chunk_size)

        # the starting data is the same for both
        of_3_retriever_2023 = benchmark_c4_dir + "chunked_go_2023_CAFA4_3.gz"

        src_collection.go_retriever_diamond_chunks_3_C4_fast(goa_old, fn_3_retriever, of_3_retriever_2023, chunk_size)
        ...
        of_3_1_nodup_2025 = benchmark_c4_dir + "chunked_go_2025_CAFA4_3_1_nodup.tsv"
        
        src_collection.remove_duplicates_and_roots_3_1(fn_3_1_nodup_2025, of_3_1_nodup_2025)

        fn_3_1_nodup_2023 = of_3_retriever_2023
        of_3_1_nodup_2023 = benchmark_c4_dir + "chunked_go_2023_CAFA4_3_1_nodup.tsv"
        ...
        of_3_5_2025 = benchmark_c4_dir + "chunked_go_2025_CAFA4_3_5.tsv"
        
        src_collection.go_quality_selection_chunks_v2_3_5(fn_3_5_2025, of_3_5_2025, chunk_size)

        fn_3_5_2023 = of_3_1_nodup_2023
        of_3_5_2023 = benchmark_c4_dir + "chunked_go_2023_CAFA4_3_5.tsv"
        ...
        of_3_6_2025 = benchmark_c4_dir + "chunked_go_2025_CAFA4_3_6.tsv"
        
        src_collection.go_quality_selection_round2_3_6(fn_3_6_2025, of_3_6_2025)

        fn_3_6_2023 = of_3_5_2023
        of_3_6_2023 = benchmark_c4_dir + "chunked_go_2023_CAFA4_3_6.tsv"
        ...
        of_3_61_2025 = benchmark_c4_dir + "chunked_go_2025_CAFA4_3_61_noobs.tsv"
        
        src_collection.substitute_obsolete_go_3_61(fn_3_61_2025, owl_data_dir, of_3_61_2025)

        fn_3_61_2023 = of_3_6_2023
        of_3_61_2023 = benchmark_c4_dir + "chunked_go_2023_CAFA4_3_61_noobs.tsv"
        ...
        of_3_69_2023 = benchmark_c4_dir + "chunked_go_2023_CAFA4_3_69_noIEA.tsv"
        
        src_collection.remove_IEA_3_69(fn_3_69_2023, of_3_69_2023)

        fn_3_69_2025 = of_3_61_2025
        of_3_69_2025 = benchmark_c4_dir + "chunked_go_2025_CAFA4_3_69_noIEA.tsv"
        ...
        of_4_evco_tagged = benchmark_c4_dir + "double_evco_CAFA4_4.tsv"
        
        src_collection.double_evco_tagger_chunks_4_C4(df_new_4_2025, df_old_4_2023, of_4_evco_tagged, chunk_size)
        ...
        benchmark_data_5_c4_dir = os.path.join(dir_tree['results_dir_path'], "knowledge_reports_cafa4")
        ensure_directory_exists(benchmark_data_5_c4_dir)
        benchmark_data_5_c4_dir = benchmark_data_5_c4_dir + "/"
        fig_hard_missing_5 = benchmark_data_5_c4_dir + "hard_missing_counts_C4.png"
        fig_overall_missing_5 = benchmark_data_5_c4_dir + "overall_missing_counts_C4.png"
        count_hard_missing_5 = benchmark_data_5_c4_dir + "hard_missing_counts_C4.tsv"
        count_overall_missing_5 = benchmark_data_5_c4_dir + "overall_missing_counts_C4.tsv"

        fn_5_selected = of_4_evco_tagged
        of_5_selected = benchmark_c4_dir + "df_with_knowledge_type_C4_5.tsv"

        src_collection.benchmark_selection_5_subcat_C4(fn_5_selected, of_5_selected, fig_hard_missing_5, fig_overall_missing_5, 
                                                    count_hard_missing_5, count_overall_missing_5)
        ...
        of_6_threshold_eval = benchmark_data_5_c4_dir + "threshold_eval_C4_6.txt"
        src_collection.gp_filtering_6_theshold_check(fn_6_threshold_check, of_6_threshold_eval)
        
        if stop_at_filtering:
            print("[STOP] threshold_eval_C4 computed, pipeline stopped as requested by 'stop_at_filtering'")
            sys.exit(1)
    else:  
    ...
    ID_list_6 = benchmark_c4_dir + f"ID_list_C4_6_{preferred_threshold_char}.tsv"
    path_to_fasta = dir_tree['dmnd_data_path'] + "/superset_cafa4.fasta"
    df_threshold = benchmark_c4_dir + f"data_with_knowledge_type_C4_6_{preferred_threshold_char}.tsv"
    df_cleaned_name = benchmark_c4_dir + f"data_with_knowledge_type_cleaned_C4_6_{preferred_threshold_char}.tsv"
    of_6_filtering = benchmark_c4_dir + f"selected_sequences_C4_threshold_{preferred_threshold_char}.fasta"
    ...
    of_6_1_nodup = benchmark_c4_dir + "data_with_knowledge_type_nodup_C4_6_1.tsv"
    ...
    ID_list_6_2 = prep_persist_dir + f"ID_list_C4_threshold_{preferred_threshold_char}_nokk.tsv"
    of_6_2_nokk = benchmark_c4_dir + f"overall_data_C4_threshold_{preferred_threshold_char}_nokk.tsv"
    of_6_2_seq = prep_persist_dir + f"query_seq_C4_thr_{preferred_threshold_char}_nokk.fasta"
    ...
    output_fasta_7 = benchmark_c4_dir + f"fasta_seqs_for_pred_C4.fasta"

    src_collection.clean_fasta_7(input_fasta_7, output_fasta_7)


    ###  ----------------- GROUND TRUTH PREPROCESSING ----------------------  ###
    cafa = "C4"  # Useful for some preprocessing functions
    ...
    of_aliasing_nx = prep_persist_dir + f"/aliases_C4_nx.tsv"  # This file must persist
    ...
    fn_gt = of_6_2_nokk
    list_name_nk = preprocessing_dir + "ID_list_NK_C4.tsv"
    list_name_lk = preprocessing_dir + "ID_list_KK_LK_C4.tsv"
    ...
    of_gt_nk_separated = preprocessing_dir + f"prep_ground_truth_NK_C4.tsv"
    of_gt_lk_separated = preprocessing_dir + f"prep_ground_truth_LK_KK_C4.tsv"
    ...
    of_gt_general = preprocessing_dir + f"prep_ground_truth_general_C4.tsv"
    ...
    of_gt_nk_def = ground_truth_dir + f'ground_truth_NK_C4.tsv'
    of_gt_lk_def = ground_truth_dir + f'ground_truth_LK_KK_C4.tsv'
    of_gt_gen_def = ground_truth_dir + f'ground_truth_general_C4.tsv'
